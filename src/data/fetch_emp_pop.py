...
kenya = kenya.rename(
    columns={
        "time": "year",
        "obs_value": "Employment_to_population"
    }
)
...
kenya.to_csv(
    "data/raw/ilo_employment_population_raw.csv",
    index=False
)

print("\nILO kenya employment to population ratio data saved successfully.")